...
namespace ReactiveList.Test
{
    ...
    public class ReactiveListAddTests
    {
        ...
        public void CanAddArrayItem()
        {
            ...
            fixture.Clear();
            fixture.Items.Count.Should().Be(0);
            fixture.AddRange(new string[] { "one", "two" });
            fixture.Items.Count.Should().Be(2);
        }
        ...
        public void CanAddComplexArrayItem()
        {
            ...
            fixture.Clear();
            fixture.Items.Count.Should().Be(0);
            fixture.AddRange(new TestData[] { new TestData("Celine", 5), new TestData("Clarence", 5), new TestData("Clifford", 5) });
            fixture.Items.Count.Should().Be(3);
        }
        ...
        public void CanAddMultipleSingleComplexItems()
        {
            ...
            fixture.Items.Count.Should().Be(1);
