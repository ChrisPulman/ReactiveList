    ...
    where T : notnull
{
    ...
    /// <summary>Gets the current items.</summary>
    /// <value>
    /// The current items.
    /// </value>
    ...
    /// <summary>Gets the items added.</summary>
    /// <value>
    /// The items added.
    /// </value>
    ReadOnlyObservableCollection<T> ItemsAdded { get; }

    /// <summary>Gets the items changed.</summary>
    /// <value>
    /// The items changed.
    /// </value>
    ReadOnlyObservableCollection<T> ItemsChanged { get; }

    /// <summary>Gets the items removed.</summary>
    /// <value>
    /// The items removed.
    /// </value>
    ...
    /// <summary>Replaces all existing items with new items.</summary>
