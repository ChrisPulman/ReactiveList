    ...
    where TKey : notnull
{
    ...
    /// <summary>Gets a collection containing all values from the underlying quads.</summary>
    ...
    /// <inheritdoc/>
    protected override IReadOnlyList<IQuad<KeyValuePair<TKey, TValue>>> BaseQuads => Quads;
    ...
    /// <summary>Adds a new entry or updates existing value.</summary>
    ...
    /// <summary>Adds a collection of key/value pairs to the cache in a single batch operation.</summary>
        ...
        where TIndexKey : notnull
    {
        ...
        for (var i = 0; i < ShardCount; i++)
        {
            ...
            try
            {
                foreach (var val in Quads[i].Values)
                {
                    index.OnAdded(val);
                }
            }
    ...
    /// <summary>Retrieves all values that match the specified key in the given secondary value index.</summary>
    ...
    /// <summary>Performs a batch edit operation on the dictionary, ensuring only a single change notification is emitted.</summary>
    ...
    /// <summary>Adds a collection of key/value pairs to the underlying data structure, distributing them across shards as appropriate.</summary>
    ...
    /// <summary>Removes the specified keys from the underlying data store, updating any associated indices as needed.</summary>
    ...
    private sealed class QuaternaryDictEditWrapper : IDictionary<TKey, TValue>
    {
        ...
        /// <summary>Gets a collection containing all keys in the dictionary.</summary>
        ...
        /// <summary>Gets a collection containing all values in the dictionary.</summary>
        ...
        /// <summary>Gets the total number of elements contained in all shards.</summary>
        public int Count
        {
            get
            {
