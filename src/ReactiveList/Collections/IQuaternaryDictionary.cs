    ...
    where TKey : notnull
{
    ...
    /// <summary>Adds a value index with the specified name, using the provided key selector to generate index keys for values.</summary>
    ...
    /// <summary>Attempts to add the specified key and value to the collection.</summary>
