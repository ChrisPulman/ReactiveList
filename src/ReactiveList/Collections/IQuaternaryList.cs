    ...
    where T : notnull
{
    ...
    /// <summary>Retrieves all entities of type T that match the specified key in the given index.</summary>
    ...
    /// <summary>Removes all elements in the specified collection from the current collection.</summary>
