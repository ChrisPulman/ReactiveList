...
public enum ChangeReason
{
    ...
    /// <summary>An item was updated/replaced in the collection.</summary>
    Update,

    /// <summary>An item was moved to a different position in the collection.</summary>
    Move,

    /// <summary>An item was refreshed (re-evaluated without modification).</summary>
    Refresh,

    /// <summary>The collection was cleared of all items.</summary>
    Clear
}
