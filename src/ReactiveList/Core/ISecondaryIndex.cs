...
{
    /// <summary>Handles logic to be performed when an item is added.</summary>
    ...
    /// <summary>Handles an update event by providing the previous and current values of the item.</summary>
